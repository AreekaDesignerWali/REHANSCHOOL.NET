...
<body>
    ...
    <section class="founder">
        ...
        <p>Welcome to Rehan.Education, where we empower teens to shape the future through digital mastery and AI innovation. Our mission is to inspire 10 million lives by equipping students with the skills to thrive in a connected world.</p>
    </section>
    <footer>
